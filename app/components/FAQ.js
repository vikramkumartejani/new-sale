  ...
  return (
    <div className='bg-black pt-[142px] pb-[75px] px-4'>
        <div className='max-w-[1015px] mx-auto border-[6px] rounded-[33px] border-dashed border-[#FF5E5E] p-5 md:p-10'>
                <h2 className='text-rtl text-[30px] sm:text-[40px] md:text-[60px] font-bold leading-[60px] md:leading-[95px] tracking-[0.01em] text-center text-[#FFFFFF]'>למקרה ששאלת..</h2>
                {/* FAQ */}
                <div className='py-[50px] md:py-[75px] lg:py-[100px]'>
                  {faqs.map((faq, index) => (
                    <div key={index} className='mb-8'>
                      ...
                      >
                        <p className='text-rtl text-[16px] leading-[24px] md:text-[20px] md:leading-[30px] lg:text-[30px] lg:leading-[40px] tracking-[0.01em] font-normal text-right mt-2 md:mt-4'>{faq.answer}</p>
                      </div>
                    </div>
                  ))}
                </div>

              <p className='text-rtl text-[20px] sm:text-[30px] md:text-[40px] leading-[40px] md:leading-[60px] text-center font-normal'>אם יש לך שאלות נוספות, אפשר לדבר איתי ישירות דרך הווטסאפ (המספר נשלח אחרי שמתחילים לעבוד עם המערכת), באמת שאין סיבה לא להתחיל..</p>
              <div className='flex flex-col md:flex-row items-center justify-between max-w-[95%] gap-[30px] mx-auto my-4 md:my-[70px]'>
                  ...
                  <div className='text-rtl bg-custom-gradient w-full md:w-[514.8px] h-[88px] md:h-[128px] rounded-[90px] flex items-center justify-center relative'>
                      ...
                      <h2 className='text-rtl text-[24px] md:text-[50px] font-semibold -mt-2 md:-mt-4'>7</h2>
                    <h4 className='text-rtl text-[16px] md:text-[30px] leading-[5px] tracking-[0.01em] text-center font-bold'>ימים</h4>
                  </div>
                </div>
                <Image src='/assets/arrow-down.svg' alt="Icons" width={50} height={83} className='mx-auto md:mx-0' />
              </div>
              ...
              <p className="text-rtl text-[15px] md:text-[25px] leading-[30px] md:leading-[55px] tracking-[0.01em] font-normal text-center mt-2">*ההצעה יכולה להיגמר ללא התרעה מוקדמת.</p>
              <p className='text-rtl text-[20px] md:text-[30px] leading-[30px] md:leading-[55px] tracking-[0.01em] font-normal max-w-[95%] mx-auto text-center mt-4'>זו ההזדמנות שלך לקחת את כל מה שיש לבינה המלאכותית להציע לעסק שלך עוד לפני שכולם שם, ולהנות מתנופה משמעותית בתקופה קריטית להצלחה שלך.</p>
        </div>
    </div>
  )
}
