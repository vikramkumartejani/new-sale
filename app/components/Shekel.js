...
const Shekel = () => {
  return (
    <div className='bg-black w-full'>
        <div className='max-w-[1920px] mx-auto w-full py-10 px-4 md:py-[212px] md:px-[100px]'>
            <div className='bg-[#141515] bg-opacity-60 rounded-[20px] p-6 md:px-20 max-w-[1720px] mx-auto'>
                <h2 className='text-custom-color max-w-full md:max-w-[1177px] mx-auto text-[32px] md:text-[85px] leading-[1.2] md:leading-[95px] tracking-[0.01em] text-center py-6 md:py-[72px]'>לשכפל את עצמך פי 10 מבלי להוציא שקל על משכורות ופרילנסרים!</h2>
            </div>
            <div className='text-white text-center max-w-full md:max-w-[950px] mx-auto text-[24px] md:text-[40px] font-bold leading-[1.2] md:leading-[49px] tracking-[0.04em] mt-6 md:mt-[63px] mb-10 md:mb-[110px]'>
                <h4 className='pb-4 md:pb-8 '>מהפכת הבינה המלאכותית מאפשרת לאנשים שלא מפחדים ללמוד דברים חדשים להתפתח בקצב של עד פי 10 מאנשים רגילים ולייצר תוצאות מדהימות.</h4>
                <h4 className='pb-4 md:pb-8'>נכון, ההתחלה קצת קשה, ולא תמיד ברור לנו איך זה בכלל יכול לעזור לנו?!</h4>
                <h4 className='pb-4 md:pb-8'>ואין ספק שלהכיר אינסוף כלים חדשים שצצים כל יום כמו פטריות אחרי הגשם - יכול להרתיע.</h4>
                <h4>אז איך בכל זאת אפשר למנף את היכולות של בינה מלאכותית בעסק, מבלי לעשות תואר בכל כלי חדש שיוצא, ומבלי שיווצר פער שישאיר אותך מאחור? </h4>
            </div>
            <div className='text-white text-center max-w-full md:max-w-[950px] mx-auto text-[24px] md:text-[59px] font-bold leading-[1.2] md:leading-[82px] tracking-[0.04em] mt-6 md:mt-[63px] mb-10 md:mb-[167px]'>
                <h5 className='text-[20px] md:text-[40px] pb-4'>או במלים אחרות:</h5>
                <h4 className='pb-4 md:pb-8'>איך להינות מעצמתם של כלי ה- AI החדשים בקלות ובנוחות, ולהכפיל את העסק שלך!</h4>
                <h4>מבלי להוציא הון עתק על עובדים ופרילנסרים.</h4>
            </div>
            <div className='max-w-full md:max-w-[1148px] mx-auto border-[3px] md:border-[6px] rounded-[33px] border-dashed border-[#FF5E5E] p-6 md:p-10 mb-10 md:mb-[122px]'>
            ...
            <div className='max-w-full md:max-w-[995px] mx-auto mb-10 md:mb-[133px]'>
            ...
            <div className='max-w-full md:max-w-[995px] mx-auto text-center mt-6 md:mt-[87px]'>
