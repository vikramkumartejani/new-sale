    ...
    <div className='bg-black w-full'>
        <div className='max-w-[1920px] mx-auto w-full py-10 px-4 md:py-[212px] lg:px-[100px]'>
            ...
            <div className='bg-[#141515] bg-opacity-60 z-40 rounded-[20px] p-6 md:px-20 max-w-[1720px] mx-auto relative'>
                <h2 className='text-custom-color max-w-full md:max-w-[1177px] mx-auto text-[32px] md:text-[50px] lg:text-[85px] leading-[1.2] md:leading-[95px] tracking-[0.01em] text-center py-6 md:py-[72px] relative z-10'>לשכפל את עצמך פי 10 מבלי להוציא שקל על משכורות ופרילנסרים!</h2>
