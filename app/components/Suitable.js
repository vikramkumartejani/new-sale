  ...
  return (
    <div className='py-[100px] text-black'>
       <div className='px-4'>
            ...
            <p className='text-rtl text-[30px] leading-[40px] md:text-[40px] md:leading-[50px] lg:text-[70px] lg:leading-[95px] tracking-[0.01em] text-center font-normal lg:px-20 max-w-[1274px] mx-auto'>
                (וסביר להניח שכן, אחרת לא היית פה), אז יוניצ'אט היא הפתרון המושלם עבורך.
            </p>
            <div className='text-rtl max-w-[1173px] mx-auto border-[6px] rounded-[33px] border-dashed border-[#FF5E5E] p-5 md:p-10 mt-[103px]'>
