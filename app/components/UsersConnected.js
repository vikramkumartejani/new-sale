  ...
  return (
    <>
        ...
        <div className="bg-black pb-[100px]">
            <div className="max-w-[1440px] mx-auto py-8 md:py-[120px] px-4">
                ...
                <ul className="custom-bullets1 py-4 md:py-[106px] tracking-[0.01em] text-right font-normal leading-[40px] md:leading-[95px] text-[18px] md:text-[40px]">
                    <li>ג’יפיטי 4o או ודאלי 3 - ₪79.90 (חודשי)</li>
                    <li>מידג’רני - ₪79.90 (חודשי)</li>
                    <li>קלוד 3 - ₪79.90 (חודשי)</li>
                    <li>סטייבל דפיוז’ן + סטביליטי אי איי - ₪99.90 (חודשי)</li>
                    <li>קורס התמחות במודל טקסט - ₪450 (חד פעמי)</li>
                    <li>קורס התמחות במודל תמונות - ₪280 (חד פעמי)</li>
                </ul>
                ...
                <h2 className="text-[25px] md:text-[45px] lg:text-[55px] leading-[35px] md:leading-[80px] lg:leading-[95px] text-center font-bold mt-4">במקום</h2>
                <h2 className="text-[30px] md:text-[60px] lg:text-[80px] leading-[35px] md:leading-[85px] lg:leading-[95px] font-normal text-center mt-2"><span className="text-[25px]">₪</span><del>350</del> בחודש + <span className="text-[25px]">₪</span><del>730</del> חד פעמי</h2>
                ...
                <h2 className="text-[50px] md:text-[70px] leading-[55px] md:leading-[95px] text-center mt-2"><span className="text-[25px]">₪</span><span className="text-[80px]">74.90</span> (בחודש)</h2>
            </div>
